...
int main(int argc, char **argv) {
    ...
    std::printf("Loader example: scripts/uart-load-image.py --device %s --text <text.bin> --data <data.bin> --monitor 0\n",
        uart.path().c_str());
